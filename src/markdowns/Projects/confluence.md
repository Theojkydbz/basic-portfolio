...
<p class="marge">How to guide a learning path through professional relationships ? A discussion-based application that improves the relationship between the student and the professional. Confluence is a junction. A space in which former students and professionals meet, work and discuss. It also opens up new possibilities for the transmission of knowledge in order to have a more natural learning path.</p>
